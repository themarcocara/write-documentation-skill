...
- **Banned phrases.** No AI vocabulary or ChatGPT-isms ("delve", "it's worth noting", "look,", "let's be honest", "sit with", and the rest of the copydesk-prose-review banned list).
